                        ...
                        <div className="modal-body">
                            ...
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input type="text" ref={username} className="form-control" id="exampleInput" />
                                </div>
                                <div className="mb-3">
                                ...
                                <button onClick={SendData} type="submit" className="btn btn-outline-primary w-100 mt-5">Register</button>
                            </form>
                        </div>
                    </div>
                </div>
